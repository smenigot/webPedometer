...
<p style="text-align: center;"><a href="https://developer.mozilla.org/en-US/docs/Web/Guide/Events/Orientation_and_motion_data_explained"><img src="doc/img/axes.png" border="0" alt="axes of smartphone" title="axes of smartphone" width="265" height="247" /></a><span style="font-size: xx-small;"> </span></p>
...
<p style="text-align: center;"><img src="doc/img/Diagramme1.png" border="0" alt="Flowchart" title="Flowchart" width="512" height="759" /></p>
...
<p> </p>
<p style="text-align: center;"><img src="doc/img/acc_xyz.png" border="0" alt="acceleration on 3 axes" title="acceleration on 3 axes" width="512" height="383" /></p>
...
<p style="text-align: center;"><img src="doc/img/eq1.png" border="0" alt="eq norm" title="eq norm" width="372" height="64" style="border: 0px none;" /></p>
...
<p style="text-align: center;"><img src="doc/img/eq2.png" border="0" alt="eq kalman gain" title="eq kalman gain" width="271" height="32" style="border: 0px none; vertical-align: middle;" /> (Optimal Kalman gain)<br /><img src="doc/img/eq3.png" border="0" alt="eq Kalman" title="eq Kalman" width="255" height="32" style="border: 0px none; vertical-align: middle;" /> (Updated acceleration estimated)<br /><img src="doc/img/eq4.png" border="0" alt="eq Kalman" title="eq Kalman" width="363" height="32" style="border: 0px none; vertical-align: middle;" /> (Updated covariance estimated)</p>
<p>where <img src="doc/img/eq5.png" border="0" alt="P_t" title="P_t" width="39" height="16" /> is the error covariance matrix,  <img src="doc/img/eq6.png" border="0" alt="a_t" width="20" height="16" /> the signal estimated at time t, <img src="doc/img/eq7.png" border="0" alt="H_t" title="H_t" width="21" height="16" /> the matrix of the estimation model and  <img src="doc/img/eq8.png" border="0" alt="R_t" title="R_t" width="20" height="16" /> the covariance of the noise mesured. Note that all parameters are initialized at 1 at the beginning of the computation.</p>
...
<p> </p>
<p style="text-align: center;"><img src="doc/img/acc_detect.png" border="0" alt="Step detection" title="Step detection" width="512" height="427" /></p>
...
<h2>Web Interface</h2>
<p style="text-align: center;"><img src="doc/img/capture1.png" border="0" alt="Main page" title="Main page" width="360" height="640" /><img src="doc/img/capture2.png" border="0" alt="Setting page" title="Setting page" width="360" height="640" /><img src="doc/img/capture3.png" border="0" alt="Menu" title="Menu" width="360" height="640" /></p>
